 ...
 */
#define FAN_MIN_PWM 40  // >=15 % for the 5015 Fan
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_ABORT "M220 S100 ; Reset Speed factor override percentage to default (100%)\nM221 S100 ; Reset Extrude factor override percentage to default (100%)\nG91 ; Set coordinates to relative\nG1 F1800 E-3 ; Retract filament 3 mm to prevent oozing\nG1 F3000 Z20 ; Move Z Axis up 20 mm to allow filament ooze freely\nG90 ; Set coordinates to absolute\nG1 X0 Y250 F1000 ; Move Heat Bed to the front for easy print removal\nM84 ;Disable all steppers"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
...
#define CUSTOM_USER_MENUS
  ...
  #define CUSTOM_USER_MENU_TITLE "Preheat Tempretures"
