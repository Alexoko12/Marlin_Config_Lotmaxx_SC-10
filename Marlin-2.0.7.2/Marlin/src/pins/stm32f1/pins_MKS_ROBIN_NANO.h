...
//
  ...
  //#define MKSPWC
      ...
      #error "LOTMAXX_BLTOUCH defined. It uses same PIN as MKS_PWC would use for SUICIDE_PIN (PB2). Define one only or change pins_MKS_ROBIN_NANO_common.h to your needs."
    #endif
