...
//#define LOTMAXX_BLTOUCH // Enable if you want to use BLTOUCH
...
#define STRING_CONFIG_H_AUTHOR "(alexoko12, config Lotmaxx SC-10)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Lotmaxx SC-10"
...
#define HEATER_0_MAXTEMP 355  // +15°C OVERSHOOT for PID --> Max Temp 340°C E3D Hotend
...
#define BED_MAXTEMP      130  // +10°C OVERSHOOT for PID --> Max Temp 120°C, Isolations Matterial kann bis 150 °C FR4 bis max 130 °C
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Lotmaxx SC-10 Standard Hotend
    //#define DEFAULT_Kp 15.50  // from pidautotune S235  1
    //#define DEFAULT_Ki  1.06  // from pidautotune S235  1
    //#define DEFAULT_Kd 59.54  // from pidautotune S235  1

    // Lotmaxx SC-10 E3D V6 Hotend
    #define DEFAULT_Kp  7.57    // from pidautotune S230  1
    #define DEFAULT_Ki  0.43    // from pidautotune S230  1
    #define DEFAULT_Kd 33.09    // from pidautotune S230  1
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Lotmaxx SC-10 Standard Bed with GFRP buildplate and isolation downside
  #define DEFAULT_bedKp 238.88 // from pidautotune S80  1
  #define DEFAULT_bedKi  46.31 // from pidautotune S80  1
  #define DEFAULT_bedKd 308.07 // from pidautotune S80  1
...
#define Y_BED_SIZE 250  // it's safer to use 228
...
#define PREHEAT_3_LABEL       "PLA Volcano"
#define PREHEAT_3_TEMP_HOTEND 240
#define PREHEAT_3_TEMP_BED     61
...
#define PREHEAT_5_TEMP_HOTEND 233
#define PREHEAT_5_TEMP_BED     81
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 3), (Y_MAX_POS - 30), 40 }
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_CALIBRATION_Y -11048
  #define TOUCH_OFFSET_X         -24
  #define TOUCH_OFFSET_Y         330
